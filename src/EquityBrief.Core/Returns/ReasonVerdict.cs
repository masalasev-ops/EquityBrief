...
public static class ReasonVerdict
{
    ...
    // The floor a live reason's record reaches before a change to section 11 and the code
    // may retire it. No runtime path retires one; the register's refusal names it.
