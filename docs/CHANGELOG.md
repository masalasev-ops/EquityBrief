...
### 2026-09-23 - ARCHITECTURE.html - section 11's thresholds paragraph replaced with a target, a rule and an exclusion
...
### 2026-09-23 - ARCHITECTURE.html - section 13.2's condition thresholds row and the sentence beneath it name the target and the ordinary nights
...
### 2026-09-23 - ARCHITECTURE.html - the facts assembler's catalogue row reads the reaction record and carries the phase 11 parts' figures
...
### 2026-09-23 - BUILD_PLAN.md - 11.9 carries the operator's addendum, and the six-thresholds obligation is told its target and its exclusion
Authorised by: A reason's threshold is calibrated to a target share of the index over ordinary nights and a night a usually quiet reason floods is left out
Was:
...
### 2026-09-23 - .claude/rules/checks.md - the read-surface roster row names the run page's region stating each reason's share against its target
Authorised by: A reason's threshold is calibrated to a target share of the index over ordinary nights and a night a usually quiet reason floods is left out
Was:
...
### 2026-09-23 - .claude/rules/checks.md - the fixture-expectations roster row names the facts file carrying the phase 11 parts' figures
Authorised by: Every number in written prose must exist in the facts file
Was:
...
### 2026-09-23 - .claude/rules/checks.md - the obligation-reconciles roster row states each phase's count of operating rows in advance
